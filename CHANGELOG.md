...
* Alerts now include link to Google Maps for point where anomaly was detected. [ashmastaflash]

* Add application uptime to performance metrics events. [ashmastaflash]

### Changes

* Increased geo drift threshold to 100m. [ashmastaflash]

* Reduce GPS update delay to 5 seconds if mode is set to &#x27;solo&#x27;. [ashmastaflash]

* Added documentation for using U-blox7 GPS device. [ashmastaflash]

* GeoIp will set to 127.0.0.1 if it fails to determine public IP address. [ashmastaflash]

* Added &#x27;solo&#x27; mode functionality for disconnected startup and operation of sensor. [ashmastaflash]

* Container logs to tty1 (HDMI) [ashmastaflash]

* GPS coordinates in all ARFCN and GSM modem channel-specific events. [ashmastaflash]

* Set default MCCs to US MCCs. [ashmastaflash]

* Set default feed url to auto-built SITCH feed. [ashmastaflash]

* Console logs to /data/sitch/log/console.log. [ashmastaflash]

* Changed &#x27;geometry&#x27; field to &#x27;location&#x27;. [ashmastaflash]

* Adding event_timestamp to application initialization log messages. [Ash Wilson]

* Add event_timestamp to sensor-generated alerts. [Ash Wilson]

* Add event_timestamp fields to messages generated by Kalibrate. [Ash Wilson]

* Changed timestamp field name in heartbeat and health_check events to event_timestamp, to be consistent with other messages&#x27; schemas. [Ash Wilson]

* Add event_timestamp to gps message structure. [Ash Wilson]

* Add event_timestamp to geoip message structure. [Ash Wilson]

* New format for gsm_modem messages. [Ash Wilson]
